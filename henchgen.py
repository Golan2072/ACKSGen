...
class character():
    ...
    def __init__ (self, level): #input character level
        ...
        self.trinket=stellagama.random_line("RPG/trinkets.txt") #generates trinket
        self.quirk=stellagama.random_line("RPG/quirks.txt") #generates quirk
